...
const Tab1Content = dynamic(() => import("./screens/ConferenceForm"), { ssr: false });
    ...
    >
      ...
      <div  className="flex-1 px-6 py-16">
        <Tabs
          ...
          defaultValue="tab1"
        >
          {/* bg-gray-950 rounded-t-lg p-4 */}
          <TabsList className="flex w-full justify-start gap-3 bg-black ">
            {["Create CFP", "Status", "Deadlines", "Permissions", "Panel"].map(
              (tab, index) => (
                <TabsTrigger
                  key={tab}
                  style={{ width: "150px" }}
          ...
          {[
            ...
            <TabsContent
              key={`tab${index + 1}`}
              style={{ width: "90%", marginLeft: "1%", height: "700px" }}
