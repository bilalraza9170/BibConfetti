...
//         const savedReviewer = await reviewerController.createReviewer(username, email, hash, Oname, CFPid, field);
...
exports.createReviewer = async (req, res) => {
    try {
        ...
        const savedReviewer = await reviewerController.createReviewer(username, email, req.body.password, req.body.Oname, req.body.CFPid, field);
